...
public class Canc extends AbstractClassifier {

    private CancClassifierModel model;
    ...
    public void buildClassifier(Instances data) throws Exception {
        ...
        model = new CancClassifierModel(lattice.getConcepts(), data);
    }
